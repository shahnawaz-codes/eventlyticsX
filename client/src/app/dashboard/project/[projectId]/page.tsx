          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-2xl border border-zinc-200 bg-white p-5 space-y-3.5 shadow-sm transition-all duration-200 hover:shadow-md hover:shadow-zinc-200/10">
                ...
                <div className="pl-8">
                  <div className="flex flex-col rounded-xl bg-zinc-900 font-mono text-xs text-zinc-100">
                    <div className="flex items-center justify-between p-3 border-b border-zinc-800">
                      <span className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider">SDK Initialization Code</span>
                      <button
                    ...
                    <pre className="p-3 text-[11px] leading-relaxed overflow-x-auto whitespace-pre">
                      {codeSnippet}
                    </pre>
                  </div>
                </div>
